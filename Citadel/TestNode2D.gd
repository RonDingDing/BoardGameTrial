...
#	var from_pos2 = Vector2(600, 400)
	...
	incoming_card1.init_card(card_name, start_scale, from_pos1, false, Data.CardMode.ENLARGE)
...
#	TweenMotion.ani_move(incoming_card1, Vector2(600, 400), Vector2(0.4, 0.4))
	TweenMotion.ani_flip_move(incoming_card1, Vector2(600, 400), Vector2(0.5, 0.5), true, false)
